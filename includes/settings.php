 ...
 */
    function nd_register_options_page() {
        add_options_page('Netlify Deploy', 'Netlify Deploy', 'manage_options', 'netlify-deploy', 'nd_options_page');
    }
 ...
 */
    function nd_status_url_render()
    {
        ...
        ?>
            <input type='text' class="input input-status-url regular-text code" name='nd_settings[status_url]' value='<?php echo $options['status_url'] ?? ''; ?>' placeholder="https://api.netlify.com/api/v1/badges/1234-5789-0123/deploy-status">
 ...
 */
    function nd_build_hook_url_render()
    {
        ...
        ?>
            <input type='text' class="input input-build-hook regular-text code" name='nd_settings[build_hook_url]' value='<?php echo $options['build_hook_url'] ?? ''; ?>' placeholder="https://api.netlify.com/build_hooks/123456789abcdefgh">
 ...
 */
    function nd_auto_depoy_render()
    {
        ...
        ?>
            <input type='checkbox' id="nd-auto-deploy" class="input input-auto-deploy" name='nd_settings[auto_deploy]' <?php checked($options['auto_deploy'], 1); ?> value='1'> <label for="nd-auto-deploy">Yes</label>
    ...
    function nd_options_page()
    {
        ...
        <div id="page-nd-options" class="wrap page-nd-options">
            ...
            <p>
                ...
                Deploy needed: <?php echo $needed; ?>
            </p>
            
            <img class="nd-status-image" src="<?php echo $options['status_url'] ;?>"/>
